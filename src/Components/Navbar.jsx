...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <li>
            <NavLink className={({ isActive }) => isActive ? 'isActive hover:bg-[#00396a] hover:text-white gray-on-dark-mode blue-border-dark-mode' : 'hover:bg-[#00396a] hover:text-white'} to='/my-attempted-assignment'>My Attempted Assignment</NavLink>
        </li>
